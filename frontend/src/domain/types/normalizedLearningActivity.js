...
exports.normalizeLearningActivity = normalizeLearningActivity;
function normalizeLearningActivity(row) {
    return {
        ...
        durationHours: row.durationHours !== undefined && row.durationHours !== null
